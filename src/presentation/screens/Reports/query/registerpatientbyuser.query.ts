...
export async function getRegisteredPatientsByUser(params?: IRangeDate) {
  console.log(params);
...
export function useGetRegisteredPatientsByUser(params?: IRangeDate) {
  return useQuery({
    queryKey: ["getRegisteredPatientsByUser"],
    queryFn: () => getRegisteredPatientsByUser(params),
    enabled: false,
  });
}